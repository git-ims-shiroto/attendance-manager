...
$page_url = admin_url( 'admin.php?page=attendance-manager' );
?>
...
<div class="wrap am-wrap">
    ...
    <div class="am-page-header">
        ...
        <p class="am-page-desc">拘束時間管理データをもとに、長距離ドライバーの月次勤怠データを確認できます。</p>
    </div>
    ...
    <div class="am-card">
        ...
        <div class="am-card-body">
            <form method="GET" action="<?php echo esc_url( $page_url ); ?>">
                <input type="hidden" name="page" value="attendance-manager">
                <?php
                $affil_map = [];
                ...
                <div class="am-form-row">
                    ...
                    <div class="am-form-group">
                        <label class="am-label" for="am-select-month">対象月</label>
    ...
    <div class="am-card">
        ...
        <div class="am-card-header" style="justify-content:space-between;">
            <span style="display:flex;align-items:center;gap:12px;">
                ...
                <span><?php echo esc_html( $selected_month ); ?>　<?php echo esc_html( $emp_info['name'] ); ?> さんの集計表（長距離）</span>
        ...
        <div id="am-save-message" style="display:none;padding:8px 20px;font-size:13px;font-weight:700;"></div>
        <div class="am-card-body">
                    ...
                    ?>
                        <tr class="<?php echo $row_class; ?>"
                            ...
                            <td class="col-date">
                                ...
                                <?php if ( ! empty( $row['kyuujitsu_kinmu'] ) ) : ?><span class="am-badge-kyukin">休日出勤</span><?php endif; ?>
                            </td>
                            <td class="col-kintai">
                            ...
                            <td class="col-jiba">
                                <label class="am-toggle">
                                    <input type="checkbox" class="am-jiba-input" <?php echo ( $row['jiba'] ?? false ) ? 'checked' : ''; ?>>
